...
# """
# AddOrg .form_valid
# EditOrgView .get_object .form_valid
# DelOrgView .get_object .delete
#
# AddLocforExistingOrgView .form_valid .get_success_url
# EditLocView .get_object .form_valid
# DelLocOfOrgView .get_object .delete
#
# AddLocMedia .get_form_class .form_valid .form_invalid
# EditLocMediaView .get_object .form_valid
# DelLocMediaView .get_object .delete
#
# Одинаковые интерфейсы для похожих классов
# 3 класса - 3 разных типа объектов
# """


# class OrLoMeMixin(Protocol):
#     """
#     Org, Loc, Media mixin
#     """
#
...
#
#
# def OLM_post_func(request) -> HttpResponse:
#     return choose_class(request.path_info)(request)


# def choose_class(path):
#     try:
#         operation_type, pk = path.info_path[25:1].split('/')
#         if operation_type == 'add-loc':
#             return AddLocBase()
#         elif operation_type == 'edit-loc':
#             return AddLocBase()
#         elif operation_type == 'del-loc':
#             return AddLocBase()
#         elif operation_type == 'add-med':
#             return AddLocBase()
#         elif operation_type == 'edit-med':
#             return AddLocBase()
#         elif operation_type == 'del-med':
#             return AddLocBase()
#         elif operation_type == 'edit-org':
#             return AddLocBase()
#         elif operation_type == 'del-org':
#             return AddLocBase()
#     except ValueError:
#         return AddOrgBase()
...
#             mapping = {
#                 'add-org': AddOrgBase,
#                 'edit-org': EditOrgView,
#                 'del-org': DelOrgView,
#                 'add-loc': AddLocBase,
#                 'edit-loc': EditLocView,
#                 'del-loc': DelLocOfOrgView,
#                 'add-med': AddLocMedia,
#                 'edit-med': EditLocMediaView,
#                 'del-med': DelLocMediaView,
#             }
#             operation_type, pk = path.info_path[25:1].split('/')
#             return mapping.get(operation_type, <AddOrgBase)()
#         except ValueError:
#             return AddOrgBase()
#
# class AddLocBase():
...
#         return super().delete(request, *args, **kwargs)
#
# """Какие нужны страницы? 1. Добавление локации к орге Ответ gpt 3:23 заслуживает внимания. Вынести атрибуты в 2
# классе и наследовать на выбор вместе с миксинами и view"""
